...
const NavBar = (props) =>{
    ...
    useEffect(() => {
        ...
        if(window.location.href.includes("/projectManager") || window.location.href.includes("/offersManager") || window.location.href.includes("/library") || window.location.href.includes("/libraryFiltersView") || window.location.href.includes("/pipingGeneral") || window.location.href.includes("/pipingPSV") || window.location.href.includes("/pipingSpecial") || window.location.href.includes("/pipingKeyParam") || window.location.href.includes("/pipingExpansionJoins")){
