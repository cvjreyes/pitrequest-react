...
export default class QtrackerDrawingPopUp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            visible : false,
          ...
          <Modal visible={this.state.visible} width="660px" height="640px" effect="fadeInUp" onClickAway={() => this.closeModal()}>
              ...
              <div className="qtrackerRequest__container">
                ...
                <thead>
                  <tr>
                    <th colSpan={3}>
                      <center className="qtracker__popUp__title" style={{marginBottom: "30px"}}><h3>Drawing\IsoStyle</h3></center>
                    </th>
                  </tr>
                </thead>
                <tbody>
