...
import QtrackerAISPopUp from "../qtrackerAISPopUp/qtrackerAISPopUp";
...
function PlusSquare(props) {
  return (
    ...
    >
      <path
        d="M6.62812 11.2678L2.65125 7.29093L6.62812 3.31406"
        stroke="white"
        stroke-width="1.5"
      ...
      />
      <path
        d="M6.62812 16.5703H13.9191C15.1496 16.5703 16.3297 16.0815 17.1998 15.2114C18.0699 14.3413 18.5587 13.1611 18.5587 11.9306V11.9306C18.5587 11.3213 18.4387 10.718 18.2056 10.1551C17.9724 9.59216 17.6307 9.08069 17.1998 8.64985C16.769 8.21902 16.2575 7.87726 15.6946 7.6441C15.1317 7.41093 14.5284 7.29092 13.9191 7.29092H2.65125"
        stroke="white"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
...
export default function MenuListPITList(props) {
  ...
  useEffect(async () => {
    if (currentMenu === "main") {
      ...
      await fetch(
        ...
        .then(async (json) => {
          ...
          if (json.isAdmin) {
            await setOptions(
              <div>
                <p className="select__text">Select your option</p>
                <div
                  className="mainmenu__item__container"
                ...
                >
                  ...
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">Software issues</p>
                    </div>
                    <img
                      src={Vector}
                      alt="vector"
                ...
                <div className="mainmenu__item__container">
                  <span
                    ...
                    onClick={() => handlePitViewClick()}
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">Requests Dashboard</p>
                    </div>
                  </span>
                </div>
                ...
                <div className="mainmenu__item__container">
                  ...
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">CAD Library</p>
                    </div>
                  </span>
                </div>
                ...
                <div className="mainmenu__item__container">
                  <span
                    style={{ display: "flex", width: "260px" }}
                    onClick={() => handleUsersViewClick()}
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">User Management</p>
                    </div>
                  </span>
                </div>
                <div className="mainmenu__item__container">
                  <span
                    style={{ display: "flex" }}
                    onClick={() => setcurrentMenu("itplan")}
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">IT Plan</p>
                    </div>
                    <img
                      src={Vector}
                      alt="vector"
        ...
        <div>
          <div className="back__item__container">
            ...
            >
              ...
              ></img>
              <div style={{ width: "260px" }}>
                <p className="back__text">MAIN MENU</p>
              </div>
            </span>
          </div>
          <div
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("aveva_eng")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Aveva Engineering</p>
              </div>
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("aveva_e3d")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Aveva E3D Design</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("aveva_diag")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Aveva Diagrams</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          ...
          >
            ...
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Smart Instrumentation</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("int_smart_3D")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Intergraph Smart 3D</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("auto_auto")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Autodesk Autocad Plant 3D</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("auto_revit")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">Autodesk Revit</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          ...
          >
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("iso")}
            >
              <div style={{ width: "480px" }}>
                <p className="mainmenu__item">IsoTracker</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
      ...
      currentMenu === "aveva_eng" ||
      currentMenu === "aveva_diag" ||
      currentMenu === "aveva_e3d"
    ) {
      await setOptions(
        <div>
          <div className="back__item__container">
          ...
          >
            ...
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">Request Item</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          <div className="mainmenu__item__container">
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("issues")}
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">Issues</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
          <div className="mainmenu__item__container">
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu("piping")}
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">Piping Spec Materials</p>
              </div>
              <img src={Vector} alt="vector" className="vector__image"></img>
            </span>
          </div>
      ...
      // Si seleccionas pulsas el boton Smart Instrumentation aparecera un submenu que mostrara estos componentes
    } else if (currentMenu === "int_smart_inst") {
      // Si el software es smart instrumentation se muestran mas componentes
      await setOptions(
        <div className="back__item__container">
          <span
            style={{ display: "flex" }}
      ...
      if (inSmart3d === true) {
        await setOptions(
          <div className="back__item__container">
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu(backMenu) && setInSmart3d(false)}
            >
              <img
                src={Vector}
                alt="vector"
              ...
              ></img>
              <div style={{ width: "260px" }}>
                <p className="back__text">REQUEST ITEM</p>
              </div>
            </span>
            ...
            <QtrackerPermissionsPopUp success={success.bind(this)} />
          </div>
        );
        ...
        await setOptions(
          <div className="back__item__container">
            <span
              style={{ display: "flex" }}
              onClick={() => setcurrentMenu(backMenu)}
            >
              <img
                src={Vector}
                alt="vector"
        ...
        await setOptions(
          <div className="back__item__container">
            ...
            >
              ...
              ></img>
              <div style={{ width: "260px" }}>
                <p className="back__text">ISSUES</p>
              </div>
            </span>
            ...
            <QtrackerCitrixPopUp success={success.bind(this)} />
          </div>
        );
        // Si no esta en el software smart3D se muestran menos campos
      } else if (inSmart3d === false) {
      ...
      await fetch(
        ...
        .then(async (json) => {
          ...
          if (json.isAdmin) {
            await setOptions(
              <div className="back__item__container__piping">
                <span
                  style={{ display: "flex" }}
                  onClick={() => setcurrentMenu(backMenu)}
                >
                  ...
                  <div style={{ width: "300px" }}>
                    <p className="back__text">PIPING SPEC MATERIALS</p>
                  </div>
                </span>
                <div className="mainmenu__item__container">
                  <span
                    style={{ display: "flex", width: "260px" }}
                    onClick={() => handleCADpmcClick()}
                  >
                    <div style={{ width: "260px", marginTop: "5px" }}>
                      <p className="mainmenu__item">CADPMC</p>
                    </div>
                  </span>
                </div>
                <div
                ...
                >
                  ...
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">SPTracker</p>
                    </div>
                  </span>
                </div>
                <div
                ...
                >
                  <span
                    style={{ display: "flex", width: "260px" }}
                    onClick={() => setcurrentMenu("instruments")}
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">Instruments</p>
                    </div>
                    <img
                      src={Vector}
                      alt="vector"
                ...
                >
                  <span
                    style={{ display: "flex", width: "260px" }}
                    onClick={() => handleSPExpansionJoinsClick()}
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">Expansion Joins</p>
                    </div>
                  </span>
                </div>
                <div
                ...
                >
                  <span
                    style={{ display: "flex", width: "260px" }}
                    onClick={() => handleSPKeyParamClick()}
                  >
                    <div style={{ width: "260px" }}>
                      <p className="mainmenu__item">Manage Catalogue</p>
                    </div>
                  </span>
                </div>
              </div>
      ...
      await setOptions(
        <div className="back__item__container__piping">
          ...
          >
            ...
            ></img>
            <div style={{ width: "300px" }}>
              <p className="back__text">PIPING INSTRUMENT</p>
            </div>
          </span>
          <div className="mainmenu__item__container">
            <span
              style={{ display: "flex", width: "260px" }}
              onClick={() => handleSPGeneralClick()}
            >
              <div style={{ width: "260px", marginTop: "5px" }}>
                <p className="mainmenu__item">General</p>
              </div>
            </span>
          </div>
          <div
          ...
          >
            <span
              style={{ display: "flex", width: "260px" }}
              onClick={() => handleSPPSVClick()}
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">PSV</p>
              </div>
            </span>
          </div>
          <div
          ...
          >
            <span
              style={{ display: "flex", width: "260px" }}
              onClick={() => handleSPSpecialClick()}
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">Special</p>
              </div>
            </span>
          </div>
        </div>
      ...
      await setOptions(
        <div className="back__item__container">
          ...
          <div className="mainmenu__item__container">
            <span
              style={{ display: "flex", width: "260px" }}
              onClick={() => handleProjectsViewClick()}
            >
              <div style={{ width: "260px", marginTop: "5px" }}>
                <p className="mainmenu__item">Tasks</p>
              </div>
            </span>
          </div>
          <div
          ...
          >
            <span
              style={{ display: "flex", width: "260px" }}
              onClick={() => handleManageProjectsViewClick()}
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">Project Manager</p>
              </div>
            </span>
          </div>
          ...
          >
            <span
              style={{ display: "flex", width: "260px" }}
              onClick={() => handleManageOffersViewClick()}
            >
              <div style={{ width: "260px" }}>
                <p className="mainmenu__item">Offer Manager</p>
              </div>
            </span>
          </div>
