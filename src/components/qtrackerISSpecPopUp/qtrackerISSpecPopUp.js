...
import './qtrackerISSpecPopUp.css'

export default class QtrackerISSpecPopUp extends Component {
    constructor(props) {
        super(props);
        this.state = {
            visible : false,
                    ...
                    <Modal visible={this.state.visible} width="700" height="800" effect="fadeInUp">
                        ...
                        <table className="table table-hover" style={{marginLeft: "10px", width: "600px", height: "280px", marginTop: "30px"}}>
                            ...
                            <tbody>
                                <tr>                   
                                    <th>
                                        <center className="th__text">SENDING</center>
                                    </th>
                                    <td>
                                        <center className="td__text">{this.props.sending}</center>
                                    </td>              
                                </tr>
