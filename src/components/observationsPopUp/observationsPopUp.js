...
export default class ObservationsPopUp extends Component {
    ...
    render() {
        ...
        return (
            <section>
                <button value="observations" className={`btn__observation__details ${this.state.obsFull ? 'obs__full' : 'obs__empty'}`} onClick={() => this.openModal()}>Details Observations</button>                
                <div>
                    <Modal visible={this.state.visible} width="650" height="500" effect="fadeInUp" onClickAway={() => this.closeModal()}>
                        ...
                        <div className="selector__container__obs">
                            ...
                            <textarea className='textarea__observations' defaultValue={this.state.observations} onChange={this.handleChange} id="textarea" >
